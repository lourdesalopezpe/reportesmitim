...
def submit():
    ...
    header = 'mitimapp/static/img/headerInspeccion.png'
    footer = 'mitimapp/static/img/footer.png'
    ...
    # Después de llamar a save(), debes retroceder al inicio del BytesIO
    pdf_io.seek(0)

    # Envía el PDF almacenado en memoria como una respuesta que se pueda descargar
...
def submit_1():
    ...
    header = 'mitimapp/static/img/headerServicio.png'
    footer = 'mitimapp/static/img/footer.png'
